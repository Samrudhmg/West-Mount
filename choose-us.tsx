...
export default function WhyChooseUs() {
    return (
        <section className="bg-[#0a2a2f] text-white w-full mx-auto py-16 px-4">
            <div className="max-w-6xl mx-auto">
                ...
                <p className=" md:text-center text-left max-w-4xl mx-auto mb-12 text-sm md:text-base">
                    At West Mount Study Abroad, we are committed to turning your
                    dream of studying abroad into a seamless, successful
                    reality. Here's why students and families trust us as their
                    partner in this life-changing journey:
                </p>
